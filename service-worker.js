const CACHE='jf-stage7-v2';
const STATIC=['./','./index.html','./styles.css','./stage7.css','./stage7.js.gz.b64','./app.js','./config.js','./manifest.webmanifest','./assets/logo-juventud-flores.png','./assets/icon-192.png','./assets/icon-512.png'];
