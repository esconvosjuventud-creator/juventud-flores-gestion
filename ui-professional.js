(function installProfessionalUI(){
  ...
  function loadAssets(){
    ...
    js('soraya-letterhead-bg1','./letterhead-bg-1.js?v=3.1.0');
    js('soraya-letterhead-bg2','./letterhead-bg-2.js?v=3.1.0');
    js('soraya-letterhead-bg3','./letterhead-bg-3.js?v=3.1.0');
    js('soraya-letterhead-bg4','./letterhead-bg-4.js?v=3.1.0');
    js('soraya-letterhead-bg5','./letterhead-bg-5.js?v=3.1.0');
    js('soraya-letterhead-bg','./letterhead-background.js?v=3.1.0');
    js('soraya-letterhead','./letterhead-template.js?v=3.1.0');
    js('soraya-letterhead-meta','./letterhead-official-meta.js?v=3.1.0');
