(function installProfessionalUI(){
  ...
  function loadAssets(){
    ...
    js('soraya-task-project-link','./task-project-link.js?v=1.0.1');
    ...
    css('soraya-calendar-pro','./calendar-professional.css?v=3.1.0');js('soraya-calendar-pro','./calendar-professional.js?v=3.1.0');
    ...
    js('soraya-letterhead-part02','./official-letterhead-part-02.js?v=4.1.0');
    js('soraya-letterhead-part03','./official-letterhead-part-03.js?v=4.1.0');
    js('soraya-letterhead-part04','./official-letterhead-part-04.js?v=4.1.0');
    js('soraya-letterhead-part05','./official-letterhead-part-05.js?v=4.1.0');
    js('soraya-letterhead-part06','./official-letterhead-part-06.js?v=4.1.0');
    js('soraya-letterhead-part07','./official-letterhead-part-07.js?v=4.1.0');
    js('soraya-letterhead-part08','./official-letterhead-part-08.js?v=4.1.0');
    js('soraya-letterhead-part09','./official-letterhead-part-09.js?v=4.1.0');
    js('soraya-letterhead-part10','./official-letterhead-part-10.js?v=4.1.0');
    js('soraya-letterhead-vector','./official-letterhead-vector.js?v=4.1.0');
    js('soraya-pdf-engine','./soraya-pdf-engine.js?v=4.1.0');
